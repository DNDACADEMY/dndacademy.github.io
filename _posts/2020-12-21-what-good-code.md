...
author: Gidong
categories: [React.JS]
tags: [code, Javascript, good-code]
image: assets/images/what-good-code/main.jpg
sitemap:
  changefreq: daily
  priority: 1.0
---

> 이 글은 [좋은 코드란 무엇일까?](https://jbee.io/etc/what-is-good-code/)의 내용을 가져왔습니다.
...
**그 땐 같았지만 지금은 같지 않은**
하지만 이렇게 공통으로 사용하고 있는 코드를 수정하는 건 어렵다. 분명 A라는 코드 조각을 동일한 로직을 수행하여 별도로 추출했지만, 시간이 지나고 A와의 조금 다른 A\* 역할로 수정이 필요해졌다.
